...
const Register = () => {
   ...
   // Phone number validation function using regular expression
    const isValidPhoneNumber = (phone) => {
        // Assume valid phone numbers are 10 digits long for this example
    ...
    const handleRegister = async () => {
      ...
      // Check for phone number format
            if (!isValidPhoneNumber(guest.phone)) {
                setLoading(false);
