            ...
            {isEditLoading ? (
                ...
                <>
                    ...
                    <div className='form-group mb-4'>
                        ...
                        <input type='text' id='brand' className='form-control' value={brand} onChange={e => setbrand(e.target.value)} />
                    </div>
                    ...
                    <div className='p-3 border mb-4'>
                        ...
                        <div className='form-group mb-4'>
                            <label className='form-label' htmlFor='price'>Price for Vehcile (per hour USD)</label>
